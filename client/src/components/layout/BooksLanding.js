    ...
    (async () => {
      try {
        const res = await axios.get(
          "/api/posts?postType=books&limit=5&select=title,gist,photoHero,createdAt"
        );
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8">
              ...
              <p>
                ব‌ই পড়তে পড়তে কখনো কালকূটের সাথে পথ চলি, কখনো ঋজু‌দার জঙ্গলে
                ঘুরে বেড়াই, কখনো নীললোহিতের সাথে দিকশূণ‍্যপুরে পাড়ি জমাই। আবার
                যখন ঠাকুরের ব‌ই পড়ি মন ঘরের কোনায় স্থির হয়ে বসে।
                <br />
              ...
              <p>
                ...
                রাখা। <br />
                মুগ্ধ হতে, বিস্মিত হতে পারা। মনকে আনন্দিত হতে দেওয়া।
              </p>
            </div>
